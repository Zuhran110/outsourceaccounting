import Mission from "../../../assets/images/AboutUs/Mission/Mission.png";
import Vision from "../../../assets/images/AboutUs/Mission/Vission.png";
    ...
    <div className="bg-blue-800 flex flex-col justify-between items-center p-8 text-white my-6 lg:my-12 mx-6 md:mx-12">
      ...
      <div className="w-auto h-auto flex flex-col lg:flex-row gap-8 justify-center items-center">
        <div className="bg-white text-black grid grid-cols-1 grid-rows-[auto_auto_1fr] h-screen p-6 justify-items-center max-w-220 lg:max-w-120 max-h-min md:max-h-90 rounded-2xl">
          <img src={Mission.src} alt="Mission" className="w-24 h-24  my-2" />
        ...
        <div className="bg-white text-black grid grid-cols-1 grid-rows-[auto_auto_1fr] h-screen p-6 justify-items-center max-w-220 lg:max-w-120 max-h-min md:max-h-90 rounded-2xl">
          <img src={Vision.src} alt="Vision" className="w-24 h-24  my-2" />
