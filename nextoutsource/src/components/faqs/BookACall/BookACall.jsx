...
const BookACall = () => {
  ...
  return (
    <div className="my-6 lg:my-12 flex justify-evenly flex-col md:flex-row bg-purple-50 p-6 md:p-12 lg:p-16">
      <div className=" flex flex-col gap-6">
        <h1 className="font-bold text-2xl md:text-3xl lg:text-4xl my-2 md:my-3 text-center lg:text-start ">
          Book a 1 - on - 1 Call
        </h1>
        <p className="max-w-140 text-center md:text-start">
        ...
        <p
          ...
          className="bg-(--color-buttonBlue) p-2 text-center text-white lg:p-4 max-w-48 rounded-lg cursor-pointer"
        >
