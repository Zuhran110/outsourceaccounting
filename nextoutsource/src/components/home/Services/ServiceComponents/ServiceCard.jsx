...
const ServiceCard = ({
  ...
  return (
    <Link href={pglink} className="no-underline text-inherit flex-wrap">
      <div className="flex flex-col items-center justify-start bg-white rounded-lg p-3 md:p-6 h-auto border border-[#333333] transition-transform w-full md:w-80  md:min-h-80 max-h-80">
