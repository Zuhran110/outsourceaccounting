...
const ServiceCard = ({ index, imgSrc, title, description }) => {
  return (
    <div className="no-underline text-inherit flex-wrap">
      <div className="flex flex-col items-center justify-start bg-white rounded-lg p-3 md:p-6 h-auto border border-gray-400 transition-transform w-60 md:w-70 min-h-50 md:min-h-65 max-h-80">
