...
const Outsource = () => {
  return (
    <>
      <div className="flex justify-center lg:justify-between items-center mx-6 my-6 md:mx-12 md:my-12 flex-wrap">
        <div className="flex flex-col h-auto justify-center lg:items-start mr-4 w-120 ">
