...
const Hero = () => {
    ...
    return (
        <section className="w-full ">
            <div className="relative h-[85vh] w-full flex flex-col md:flex-row items-center justify-center md:justify-between overflow-hidden ">

                {/* Background Image */}
                <img src={CountrySideUK} alt="Country side view" className="absolute inset-0 w-full h-full object-cover brightness-50 -z-10" />
                ...
                <div className="w-full md:w-1/2 px-6 md:pl-16 text-white flex flex-col justify-center ">
                    ...
                    <h1 className="text-3xl md:text-5xl font-bold mb-6 leading-snug">
                        Cheap <span className="text-(--color-veryLightBlue)">Online Accounting</span> & Tax Filing Services in the UK{" "}
                        <img src={UKFlagIcon} alt="uk flag" className="inline-block w-8 h-8 ml-2" />
                    </h1>

                    {/* Hidden on small screens */}
                    <p className="hidden md:block mb-4">
                        Outsource Accounting is your trusted, reliable, and cheap online accounting and tax services
                        partner. Chin up, we handle your Companies House and HMRC filings from only £75 per year.
                    </p>

                    <p className="hidden md:block mb-8">
                        Give your business the boost it deserves! Fancy a chat with our expert UK accountants?
                        Reach out today!
                    </p>
                ...
                {/* RIGHT FORM SECTION */}
                <div className="w-full md:w-1/3 md:mr-16 bg-white/40 backdrop-blur-lg p-8 md:p-12 rounded-xl shadow-lg mt-10 md:mt-0 mx-12 md:mx-0">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="mb-4">
                            <input
                                ...
                                className="w-full p-4 bg-amber-50 border border-gray-300 rounded text-sm focus:border-indigo-600 focus:ring-2 focus:ring-indigo-300 outline-none"
                        ...
                        <div className="mb-4">
                            ...
                            {errors.companyTurnover && <p className="text-red-500 text-xs mt-1">{errors.companyTurnover.message}</p>}
                        </div>
