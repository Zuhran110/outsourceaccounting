...
const Card = ({ index, imgComponent, title, content }) => {
    ...
    return (
        <div className="flex flex-col items-start justify-start gap-3 min-w-10 w-auto max-w-60 border border-gray-300 p-6 mb-2 mx-1 min-h-48 rounded-lg shadow-md bg-white">
            <img
                src={imgComponent}
                alt={title}
